...
interface FlashcardStackControlProps {
    onSkip: () => void
    onMaster: () => void
}

const FlashcardStackControls = ({ onSkip, onMaster }: FlashcardStackControlProps): JSX.Element => {
    return (
...
export default FlashcardStackControls
